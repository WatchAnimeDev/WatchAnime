...
function AnimeRelationComponent({ animeData }) {
    ...
    return <>{relatedData.length ? <AnimeSectionComponent sectionTitle={"RELATED ANIME"} sectionAnimeData={relatedData} hasViewMore={false} sliderConfig={animeSliderConfig} /> : ""}</>;
}
